...
### Changed
- أعيد تصميم واجهة القارئ كسطح macOS أصلي: شريط نافذة وأزرار حركة النظام، عنوان مركزي،
  شريط جانبي شبيه بـFinder، قوائم وpopovers زجاجية، أزرار مقسمة، ألوان نظام دلالية،
  وخط واجهة Apple على macOS مع بقاء خط القراءة مستقلًا وقابلًا للتخصيص.
- مخططات Mermaid تعيد التصيير عند تبديل السمة، فتتبع الوضع الفاتح أو الداكن فورًا.
- لقطات المشروع تُلتقط من مجلد كامل لإظهار شجرة الملفات ومكوّنات سطح المكتب الفعلية.
