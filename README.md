...
واجهة تشبه تطبيقات macOS الأصلية، مع سمات للقراءة وخطوط عربية ومعادلات ومخططات وتصدير؛ تعمل محليًا دون اتصال.
...
- 🖥️ **تجربة Mac أصلية المظهر** — شريط نافذة وأدوات، وsidebar شبيه بـFinder، وألوان نظام، وpopovers ومواد شفافة تتبع الوضعين الفاتح والداكن.
