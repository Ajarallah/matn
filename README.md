...
- 🖱️ **سحب وإفلات** لأي `.md` على النافذة، أو **الصق** ماركداون من الحافظة مباشرة (`⌘V`) — مخرجات وكيل، أو مقطع من محادثة — مع تراجع يعيد ما كان مفتوحا.
- 🔔 **يخبرك بما تغيّر** — عند تعديل الملف من الخارج يبقى موضعك كما هو، ويشير إلى القسم الذي تغيّر لتذهب إليه إن شئت.
